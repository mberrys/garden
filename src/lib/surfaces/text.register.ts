...
registerSurface({
  ...
  adapter: {
    engine: "borrowed",
    status: "active",
    userEdits: "ProseMirror transactions map to spliceBlocks; Garden owns undo",
    gardenUpdates: "adapter.update replaces EditorState from Garden JSON with an applying guard",
    selection: "block range + selected text from ProseMirror selection",
    notes: "Live EditorView in writer-editor.tsx. No prosemirror-history. Markdown remains import/export.",
    relatedIssue: 33,
  },
