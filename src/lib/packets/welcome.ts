...
export const welcomePacket: SeedPacket = {
  ...
  version: 1,
  label: "Welcome",
  blurb: "The first-run tour: a document, a diagram of how edits flow, and a starter deck.",
  starterArtifacts: [
    ...
    { localId: "deck", kind: "deck", title: "A generative document workplace", build: deckDoc },
  ],
  layout: {
    open: [
